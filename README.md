...
An optional **two-level model fallback** automatically detects degenerate three-level structures (τ²_within ≈ 0), notifies the user transparently, and reverts to the appropriate two-level model.

</details>

<details>
<summary><strong>Click to expand: Exact VCV Construction for Shared Controls</strong></summary>
...
<details>
<summary><strong>Click to expand: CR2 Cluster-Robust Variance Estimation</strong></summary>
...
<details>
<summary><strong>Click to expand: Non-Linear Spline Meta-Regression</strong></summary>
...
<details>
<summary><strong>Click to expand: Publication Bias Assessment</strong></summary>
...
<details>
<summary><strong>Click to expand: Validation results</strong></summary>
...
<details>
<summary><strong>Click to expand: Worked example — Curtis & Wang (1998) CO₂ dataset</strong></summary>
...
<details>
<summary><strong>Click to expand: Session reproducibility & automated reporting</strong></summary>
...
Loading the session file in a fresh Colab runtime restores the complete configuration and enables exact one-click reproduction. The JSON schema is human-readable and version-controlled, making it suitable for deposition as supplementary material.

After each analysis module executes, CoMeta also generates dynamically adapted *Materials and Methods* and *Results* text. The generator:
...
- Formats numerical results according to journal conventions (e.g., *d* = 0.42, 95% CI [0.18, 0.66], *p* = .003).
